...
```{r b,cache=TRUE,eval=TRUE,dependson="a",message=FALSE,warning=FALSE}
...
```{r c,cache=TRUE,eval=TRUE,dependson="b",message=FALSE,warning=FALSE}
...
```{r k,cache=TRUE,eval=TRUE,dependson="a",message=FALSE,warning=FALSE}
library(org.Mm.eg.db)
...
```{r e,cache=TRUE,eval=TRUE,message=FALSE,warning=FALSE}
library(DEXSeq)
...
```{r f,cache=TRUE,eval=TRUE,message=FALSE,warning=FALSE}
