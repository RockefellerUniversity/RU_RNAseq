...
```{r instalcscldcsceBSded,cache=TRUE,eval=TRUE}
library(ShortRead)
library(ggplot2)
...
```{r instaaxscslldebbBSccdxxed,cache=TRUE,eval=FALSE,dependson="instalcscldcsceBSded"}
...
```{r instaaxscslldebbzBSccdxxed2,cache=FALSE,eval=FALSE}
library(BSgenome.Mmusculus.UCSC.mm10)
...
```{r instacsxsjiijcsllBSdessd,eval=FALSE}
