...
---
## RNA-seq for differential gene and transcript expression
...
The [**subjunc()** function requires arguments for the index to align to, the fastQ to align and the name of output BAM](https://rockefelleruniversity.github.io/Bioconductor_Introduction/r_course/presentations/slides/AlignmentInBioconductor.html#34)
...
library(Rsamtools)
sortBam("Treg_1.bam","Sorted_Treg_1.bam")
...
We retrieve a matrix of counts from either **RangedEummarizedExperiment** object using the **assay()** function.
...
myQuant <- read.delim("~/Downloads/TReg_1_Quant2/quant.sf")
myQuant[1:3,]
```
---
