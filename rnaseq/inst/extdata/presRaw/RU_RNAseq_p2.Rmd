...
toCompare <- cbind(abs(swde$log2FoldChange.x) > 0.5 & swde$padj.x < 0.05 & !is.na(swde$padj.x) & !is.na(swde$padj.y), abs(swde$log2FoldChange.y) > 0.5 & swde$padj.y < 0.05 & !is.na(swde$padj.y) & !is.na(swde$padj.x))
