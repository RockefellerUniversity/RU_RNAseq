...
An alternative is that we translate our human MSigDB collection to other organisms. Thankfully someone already did just this for us, for a number of common species. This is all wrapped up in the *msigdbr* package.
...
```{r func1,eval=TRUE,echo=TRUE,cache=TRUE,dependson="func", warning=F, message=F, fig.height=5,fig.width=5}
library(goseq)
