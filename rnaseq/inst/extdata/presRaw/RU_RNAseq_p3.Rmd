...
```{r, Readinggmt, eval=F, echo=T}
hallMarks <- getGmt("~/Downloads/h.all.v7.1.symbols.gmt")
hallMarks
```

```{r, Readinggmt, eval=T, echo=F}
hallMarks <- getGmt("/Users/mattpaul/Documents/Box Sync/RU/Teaching/Compilation/Genomes_And_Datasets/RNAseq_course/h.all.v7.1.symbols.gmt")
hallMarks
```
...
Mm.H <-readRDS("~/Downloads/Mm.h.all.v7.1.entrez.rds")
class(Mm.H)
```

```{r, wehi, echo=F, eval=T}
