...
if(!file.exists("filtered_ENCFF070QMF.fastq.gz")){
  writeFastq(fastqFilt,"filtered_ENCFF070QMF.fastq.gz")
}
```

### 3. Alignment
3. Align our filtered reads to the chromosome 10 of mm10 genome. Sort and index the resulting BAM file.

```{r instaaxscslldebbzBSccdxxed2,cache=FALSE,eval=TRUE,echo=toMessage}
if(!file.exists("Sorted_Treg_2.bam")){
library(BSgenome.Mmusculus.UCSC.mm10)
