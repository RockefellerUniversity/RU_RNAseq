...
1. Identify KEGG functions enriched in genes significantly upregulated in Liver.
...
2. Plot the -log10 pvalue for top 5 terms as point plot.
...
3. Using the Salmon qunatifications, plot the top 10 enriched terms in GO biological processes for genes upregulated in Heart.

```{r g,cache=TRUE,eval=TRUE,warning=FALSE,echo=toMessage}
