...
## ----de222z,eval=TRUE,echo=TRUE,cache=F,dependson="de22z",warning=FALSE,message=FALSE----
library(DEXSeq)
...
## ----de222zTT,include=FALSE,cache=F,dependson="de222z"------------------------
mcols(senescence_ExonCounts)$gene_id <- unlist(mcols(senescence_ExonCounts)$gene_id)


## ----de2223z,eval=TRUE,echo=TRUE,cache=F,dependson="de222zTT",warning=FALSE,message=FALSE----
...
## ----de223l,eval=TRUE,echo=TRUE,cache=F,dependson="de2223z",warning=FALSE,message=FALSE----
